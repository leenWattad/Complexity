...
.L_lambda_opt_code_0001:
	...
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0001 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0001 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0001
...
.L_lambda_opt_params_loop_0002:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0002
...
.L_lambda_opt_arity_check_more_0001:
	...
	mov rax, sob_nil
	mov r15, [rsp + 8 * 2]
	lea rbx, [rsp + 8 * 2 + 8 * r15]
	sub r15, 0
.L_lambda_opt_stack_shrink_loop_0001:
	mov rdx, [rbx] ;
	mov rcx, rax
	mov rdi, (8 * 2 + 1)
	call malloc ; address is returned to rax
	mov byte [rax], T_pair
	mov SOB_PAIR_CAR(rax), rdx ; list is constructed by pairs.
...
.L_lambda_opt_stack_shrink_loop_exit_0001:
	mov [rsp + 8 * 2 + 8 * 1], rax
	mov r15, 1
	mov [rsp + 8 * 2], r15 ; new params length
	mov r14, rsp
	add r14, 8 * 2 + 8 * 1
	sub r13, [rsp + 8 * 2] ; 
	mov r15, r13
...
.L_lambda_opt_params_loop_0003:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0003
...
.L_lambda_opt_code_0002:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0002 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0002 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0002
...
.L_lambda_opt_params_loop_0005:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0005
...
.L_lambda_opt_params_loop_0006:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0006
...
.L_lambda_opt_code_0003:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0003 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0003 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0003
...
.L_lambda_opt_params_loop_0008:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0008
...
.L_lambda_opt_params_loop_0009:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0009
...
.L_lambda_opt_code_0004:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0004 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0004 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0004
...
.L_lambda_opt_params_loop_000b:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_000b
...
.L_lambda_opt_params_loop_000c:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_000c
...
.L_lambda_opt_code_0005:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0005 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0005 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0005
...
.L_lambda_opt_params_loop_000e:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_000e
...
.L_lambda_opt_params_loop_000f:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_000f
...
.L_lambda_opt_code_0006:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0006 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0006 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0006
...
.L_lambda_opt_params_loop_0011:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0011
...
.L_lambda_opt_params_loop_0012:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0012
...
.L_lambda_opt_code_0007:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0007 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0007 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0007
...
.L_lambda_opt_params_loop_0014:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0014
...
.L_lambda_opt_params_loop_0015:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0015
...
.L_lambda_opt_code_0008:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 2
	je .L_lambda_opt_arity_check_exact_0008 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0008 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0008
...
.L_lambda_opt_params_loop_0017:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0017
...
.L_lambda_opt_params_loop_0018:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0018
...
.L_lambda_opt_code_0009:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 2
	je .L_lambda_opt_arity_check_exact_0009 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0009 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0009
...
.L_lambda_opt_params_loop_001a:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_001a
...
.L_lambda_opt_params_loop_001b:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_001b
...
.L_lambda_opt_code_000a:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_000a ;  no opt params
	jg .L_lambda_opt_arity_check_more_000a ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000a
.L_lambda_opt_arity_check_exact_000a:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_001d:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_001d
...
.L_lambda_opt_params_loop_001e:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_001e
...
.L_lambda_opt_code_000b:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_000b ;  no opt params
	jg .L_lambda_opt_arity_check_more_000b ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000b
...
.L_lambda_opt_params_loop_0020:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0020
...
.L_lambda_opt_params_loop_0021:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0021
...
.L_lambda_opt_code_000c:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_000c ;  no opt params
	jg .L_lambda_opt_arity_check_more_000c ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000c
.L_lambda_opt_arity_check_exact_000c:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0023:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0023
...
.L_lambda_opt_params_loop_0024:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0024
...
.L_lambda_opt_code_000d:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_000d ;  no opt params
	jg .L_lambda_opt_arity_check_more_000d ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000d
...
.L_lambda_opt_params_loop_0026:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0026
...
.L_lambda_opt_params_loop_0027:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0027
...
.L_lambda_opt_code_000e:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_000e ;  no opt params
	jg .L_lambda_opt_arity_check_more_000e ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000e
.L_lambda_opt_arity_check_exact_000e:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0029:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0029
...
.L_lambda_opt_params_loop_002a:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_002a
...
.L_lambda_opt_code_000f:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_000f ;  no opt params
	jg .L_lambda_opt_arity_check_more_000f ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_000f
...
.L_lambda_opt_params_loop_002c:
	...
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_002c
...
.L_lambda_opt_params_loop_002d:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_002d
...
.L_lambda_opt_code_0010:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0010 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0010 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0010
.L_lambda_opt_arity_check_exact_0010:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_002f:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_002f
...
.L_lambda_opt_params_loop_0030:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0030
...
.L_lambda_opt_env_end_0011:
	pop rbx
	mov rsi, 0
.L_lambda_opt_params_loop_0031:	; copy params
	cmp rsi, 1
	je .L_lambda_opt_params_end_0031
	mov rdx, qword [rbp + 8 * rsi + 8 * 4]
	mov qword [rbx + 8 * rsi], rdx
	inc rsi
	jmp .L_lambda_opt_params_loop_0031
.L_lambda_opt_params_end_0031:
	mov qword [rax], rbx	; ext_env[0] <-- new_rib 
	mov rbx, rax
	pop rax
	mov byte [rax], T_closure
...
.L_lambda_opt_code_0011:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0011 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0011 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0011
.L_lambda_opt_arity_check_exact_0011:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0032:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0032
...
.L_lambda_opt_params_loop_0033:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0033
...
.L_lambda_opt_code_0012:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0012 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0012 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0012
.L_lambda_opt_arity_check_exact_0012:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0035:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0035
...
.L_lambda_opt_params_loop_0036:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0036
...
.L_lambda_opt_code_0013:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0013 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0013 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0013
.L_lambda_opt_arity_check_exact_0013:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0038:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0038
...
.L_lambda_opt_params_loop_0039:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0039
...
.L_lambda_opt_code_0014:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0014 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0014 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0014
.L_lambda_opt_arity_check_exact_0014:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_003b:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_003b
...
.L_lambda_opt_params_loop_003c:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_003c
...
.L_lambda_opt_code_0015:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 1
	je .L_lambda_opt_arity_check_exact_0015 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0015 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0015
.L_lambda_opt_arity_check_exact_0015:
	mov rdx, 3 + 1
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_003e:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_003e
...
.L_lambda_opt_params_loop_003f:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_003f
...
.L_lambda_opt_code_0016:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0016 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0016 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0016
.L_lambda_opt_arity_check_exact_0016:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0041:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0041
...
.L_lambda_opt_params_loop_0042:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0042
...
.L_lambda_opt_code_0017:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0017 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0017 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0017
.L_lambda_opt_arity_check_exact_0017:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0044:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0044
...
.L_lambda_opt_params_loop_0045:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0045
...
.L_lambda_opt_code_0018:
	mov r15, qword [rsp + 8 * 2]
	cmp r15, 0
	je .L_lambda_opt_arity_check_exact_0018 ;  no opt params
	jg .L_lambda_opt_arity_check_more_0018 ;  at least one opt param
	jl L_error_incorrect_arity_opt
	jmp .L_lambda_opt_arity_check_exact_0018
.L_lambda_opt_arity_check_exact_0018:
	mov rdx, 3 + 0
	sub rsp, 8
	mov qword rbx, rsp
.L_lambda_opt_params_loop_0047:
	mov qword rcx, [rbx + 8]
	mov qword [rbx], rcx
	add rbx, 8
	dec rdx
	cmp rdx, 0
	jg .L_lambda_opt_params_loop_0047
...
.L_lambda_opt_params_loop_0048:
	...
	dec r8
	cmp r8, 0
	jg .L_lambda_opt_params_loop_0048
...
.L_lambda_simple_end_00ba:	; new closure is in rax
	...
	mov rax, L_constants + 2270
	push rax
	mov rax, qword [free_var_151]	; free var x
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	push rax
	push 2	; number of args
